    ...
    <main>   
      ...
      <Modal toggleModal={toggleModal} setToggleModal={setToggleModal}>
        <div className="mx-auto w-full overflow-auto p-3">
          ...
          <Script src="https://app.nectarcrm.com.br/crm/api/1/webform/view-embedded/nOuHygIjIFbTD9d21ZNkEakE580mrG0IUc3HTOnJjw" data-nectar-webform-destination-elem="pagedef" defer></Script>
