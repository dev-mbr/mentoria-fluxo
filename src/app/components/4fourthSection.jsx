        ...
        <main className="bg-[#F5F5F5] pb-[7.5rem] sm:pb-16">
            ...
            <section className="flex flex-col items-center">
                <div className="sm:flex sm:flex-col sm:items-center">
                    <div className="text-[#585852] font-medium text-[1.25rem] sm:text-[1rem] ml-12 sm:mx-auto mt-[7.5rem] sm:mt-16 sm:text-center sm:w-[21.4rem]">
                        ...
                        <p className="mt-4">
                        Nos grupos exclusivos da comunidade Fluxo, você <strong>conversa abertamente, tira <br /> dúvidas e troca experiências</strong> com pessoas que já chegaram onde você quer chegar.
                        </p>
                    </div>
                    <div>
            ...
            <section>
                    <div className="text-center text-[1.25rem] sm:text-[1rem] text-[#585852] font-medium mx-auto flex flex-col items-center w-[50rem] sm:w-[21.4rem] mt-[5.5rem]">
                        ...
                        <p className="mt-6">
                        Parece chato? Sim! Mas é um dos depoimentos mais emocionantes que recebi. Tenho certeza que <strong>isso retrata a situação de várias pessoas.</strong>
                        </p>
                        <p>
                    ...
                    <Image className="mx-auto mt-12 sm:mt-10 relative z-10 sm:w-[screen]" src={textao} alt=""/>
