...
const depoimentos = [
  {
    ...
    resumo: (
      <>
        Morava de favor e recebia R$200 por mês. <br className="sm:hidden" />
        Entrou no Fluxo e em menos de um ano faturou{" "}
        <strong>600 MIL REAIS.</strong>
      </>
    ),
    thumb: "giovanna.png",
  ...
  },
  {
    ...
    resumo: (
      <>
        Entrou no Fluxo e <br className="sm:hidden" />
        faturou mais de <br className="sm:hidden" />
        <strong>1 MILHÃO</strong> de reais, sem precisar botar a cara na
        internet.
      </>
    ),
  ...
  },
  {
    ...
    resumo: (
      <>
        Faturou com o Fluxo em <br className="sm:hidden" /> 4 meses o que não
        faturava em um ano. <br className="sm:hidden" /> Pode isso, produção?{" "}
        <br className="sm:hidden" /> Pode e com força.
      </>
    ),
  ...
  },
  {
    ...
    resumo: (
      <>
        “Foi a segunda melhor decisão da nossa vida”.{" "}
        <br className="sm:hidden" /> E qual foi a primeira? Sim, vou te fazer
        assistir ao vídeo para saber.
      </>
    ),
  ...
  },
  {
    ...
    resumo: (
      <>
        Manda quem pode e obedece quem tem esposa. Praticamente obrigou o marido
  ...
  },
  {
    ...
    resumo: (
      <>
        Do zero ao Fluxo, do <br className="sm:hidden" />
        Fluxo ao apartamento <br className="sm:hidden" />
  ...
  },
  {
    ...
    resumo: (
      <>
        Conquistou mais de <br className="sm:hidden" />
        1400 alunos e um faturamento de mais de{" "}
        <br className="hidden sm:block" />
        <strong>100 MIL reais</strong>, após <br className="sm:hidden" />
        entrar no Fluxo.
      </>
    ),
    ...
    <div>
      <div className="max-w-[75rem] sm:w-[21.4rem] mx-auto mt-[5rem] sm:mt-[2.5rem] flex flex-wrap justify-center gap-10">
        {depoimentos.map((depoimento, index) => (
          <div
            key={index}
            className="w-[16.875rem] sm:w-[21.375rem] bg-[#292929] rounded-2xl pb-6 cursor-pointer"
          ...
          >
            ...
            <div className="w-[13.875rem] sm:w-[18.375rem] mx-auto mt-6">
              ...
              <p className="mt-3 text-[#B2B2B2]">{depoimento.resumo}</p>
