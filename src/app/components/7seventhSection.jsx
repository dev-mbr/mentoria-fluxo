    ...
    <main className="bg-black text-white">
      <section className="flex flex-col items-center font-medium">
        ...
        <div className="flex flex-col items-center mt-4">
          ...
          <p className="mt-10 text-[1.25rem] sm:text-[1rem] leading-8 w-[36rem] sm:w-[21.375rem] text-center">
            ...
            <strong>preciso te dar um aviso muito importante:</strong>
          </p>
        </div>
        ...
        <div className="w-[50rem] sm:w-[21.4rem] rounded-2xl bg-[#292929] mt-[7.5rem] sm:mt-16 flex flex-col items-center py-12 sm:py-6 z-10 text-[1.25rem] sm:text-[1rem]">
          ...
          <div className="w-[44rem] sm:w-[18.375rem] mt-10">
            ...
            <p className="leading-8  mt-8">
              A Crislaine, nossa atendente, além de tirar todas as suas dúvidas,
              vai te mostrar oportunidades que você nunca viu em nenhum outro
              lugar e eu acho muito difícil que você deixe essa chance passar.
            </p>
            <p className="leading-8  mt-8">
              Praticamente todas as pessoas que conversam com ela entram para o
              Fluxo.
            </p>
            ...
            <p className=" mt-[.81rem]">
              A Crislaine recebe comissões das vendas do Fluxo, olha só o
              carrinho novo que ela comprou, à vista:
            </p>
          </div>
          ...
          <div className="w-[44rem] sm:w-[18.375rem]">
            <p className=" mt-6">
              Não subestime a Cris. <br className="hidden sm:block" /> As
              oportunidades que ela vai te oferecer são absurdas.{" "}
              <br className="hidden sm:block" /> Agende a ligação de
      ...
      <footer className="mt-[7.5rem] sm:mt-16 pb-8">
        ...
        <p className="text-[#ffffff7a] sm:text-[.625rem] text-center font-semibold mt-8">
          ...
          <strong>READY TO GO EDUCATION</strong> / CNPJ: 37.643.030/0001-26
        </p>
      </footer>
    </main>
  );
